    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">
                กรอกข้อมูลเพื่อสร้างรายวิชาใหม่
            </p>
        </div>
            ...
            <form action="{{ route('teacher.courses.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        เลือกชื่อรายวิชาที่ชัดเจนและบ่งบอกเนื้อหาของรายวิชา
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="6"
                        ...
                        placeholder="อธิบายสิ่งที่นักเรียนจะได้เรียนรู้ในรายวิชานี้..." required>{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        ให้ภาพรวมโดยละเอียดของเนื้อหารายวิชาและผลลัพธ์การเรียนรู้
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div id="imagePreview" class="mt-4 hidden">
                        <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ตัวอย่างภาพ:</p>
                        <img id="preview" class="max-w-full h-48 rounded-lg shadow-lg" alt="ตัวอย่างภาพปกรายวิชา">
                    </div>
                </div>
