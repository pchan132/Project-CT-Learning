    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('teacher.courses.index') }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 font-semibold text-sm">
                    View All →
                </a>
            </div>
        </div>
                ...
                @foreach($courses->take(6) as $course)
                    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                        ...
                        <div class="relative h-40 bg-gradient-to-r from-indigo-500 to-purple-600">
                            ...
                            <!-- Stats Badge -->
                            <div class="absolute top-3 right-3 bg-white dark:bg-gray-800 rounded-lg px-2 py-1 shadow-lg">
                                <div class="flex items-center space-x-1">
                                    <svg class="w-4 h-4 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                                    </svg>
                                    <span class="text-xs font-semibold text-gray-700 dark:text-gray-300">{{ $course->enrollments->count() }}</span>
                                </div>
                            </div>
                        </div>
