    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">แก้ไขข้อมูลคอร์ส</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400">อัพเดทข้อมูลคอร์สและเปลี่ยนผู้สอนได้</p>
            </div>
            ...
            <form action="{{ route('admin.courses.update', $course) }}" method="POST" enctype="multipart/form-data"
                ...
                @if ($course->cover_image_url)
                    <div class="mb-6">
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">รูปหน้าปกปัจจุบัน</label>
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        <span class="text-yellow-600">⚠️</span> การเปลี่ยนผู้สอนจะทำให้ผู้สอนใหม่เป็นเจ้าของคอร์สแทน
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    @error('cover_image_url')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">เว้นว่างไว้ถ้าไม่ต้องการเปลี่ยน</p>
                </div>
