...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <!-- System Settings -->
            <div class="bg-gradient-to-r from-gray-500 to-gray-600 rounded-lg shadow-lg p-6 opacity-60">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-xl font-bold text-white mb-2">System Settings</h3>
                        <p class="text-gray-100">Coming soon...</p>
                    </div>
