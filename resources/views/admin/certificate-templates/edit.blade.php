                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-6">
                            ...
                            <div>
                                @if ($template->background_image)
                                    <div class="mb-4">
                                        <img src="{{ asset('storage/' . $template->background_image) }}" alt="Background"
                                            class="w-full max-w-md object-contain bg-gray-100 p-2 rounded-lg border">
                                        <p class="text-xs text-gray-500 mt-1">ภาพพื้นหลังปัจจุบัน</p>
                                    </div>
                                @endif
